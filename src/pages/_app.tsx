...
export default function App({ Component, pageProps }: AppProps) {
  return <>
    <Head>
      ...
      <meta property="og:image" content="/opal-logo-nobg.png" />
      ...
      <meta name="twitter:image" content="/opal-logo-nobg.png" />
      ...
      <meta property="pinterest:image" content="/opal-logo-nobg.png" />
    </Head>
    <div>
      <Component {...pageProps} />
    </div>
