            ...
            <div className="container px-4 py-2">
                <div className="flex items-center justify-between gap-4 lg:gap-10">
                    ...
                    <nav
                        ...
                        aria-label="Global"
                        className={`bg-primary-white text-dark-purple gap-8 text-sm font-medium top-0 bottom-0 h-screen md:h-auto ${mobileOpen ? "left-0" : "-left-full md:left-0"
                    ...
                    <div className="hidden flex-1 items-center justify-end gap-4 sm:flex">
                        <Link className="bg-dark-purple text-primary-white w-fit px-6 py-2 font-semibold text-sm " href={"/contact-us"}>
                            Contact us
                        </Link>
                    </div>

                    <div className="md:hidden">
                        <button className="rounded-lg p-2 text-gray-900" type="button" onClick={() => setMobileOpen((p) => !p)}>
